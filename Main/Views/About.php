...
<div  class="grid grid-cols-3 justify-items-center text-black gap-10 lg:w-[80%] m-auto my-20">
  <div  class=" mt-10 md:mt-0 lg:mt-0 col-span-3 lg:col-span-1 p- lg:order-2 justify-items-center content-center ">
    ...
    <p class="text-lg px-4 ">
      House to Home Solutions was founded in 2024 with one simple mission: to help your house truly feel like home. 
      Whether it’s fixing what’s broken, refreshing what’s worn, or installing something brand new, we’re here to help every step of the way. 
      From repairs and renovations to custom installations and more, we take pride in reliable service, quality craftsmanship, and making your vision a reality—one project at a time. 
